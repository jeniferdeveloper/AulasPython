"""Listas
1. Crie uma lista com 8 números inteiros e exiba o quinto elemento.
2. Remova todos os números ímpares de uma lista.
3. Crie uma lista com nomes de 5 frutas e verifique se a fruta "Maçã" está presente.
4. Multiplique todos os elementos da lista por 2 e exiba o resultado.
5. Inverta a ordem dos elementos de uma lista sem usar reverse()."""
